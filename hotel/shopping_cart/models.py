...
class OrderItem(models.Model):
	product = models.OneToOneField(Room, on_delete = models.SET_NULL, null = True)##Aqui debe cambiarse 
...
class Order(models.Model):
	...
	def get_cart_total(self):
		return sum([item.product.tipo_habitacion.precio for item in self.items.all()])
